...
{{--                        </div>--}}
                        <div class="blog-content">
                            ...
                            <ul class="meta">
                                ...
                                <li><i class="fa fa-user-circle"></i> Posts by : {{$detail['author_name']}}</li>
                            </ul>
                            <div class="desc">
                                {!! $detail['content'] !!}
                            </div>
                    ...
                    <div class="related-post mb-30">
                        <h4 class="last-title mb-20">相关新闻</h4>
                        <div class="row">
                            @if(!empty($release))
                                @foreach($release as $item)
                                    <div class="col-lg-4 col-md-4 col-sm-6">
                                        ...
                                        <div class="single-blog">
                                            ...
                                            <div class="blog-content">
                                                <h5 class="title"><a
                                                        href="{{route('article.detail',['id'=>$item['id']])}}">{{$item['title']}}
                                                    </a></h5>
                                                <ul class="meta">
                                                    <li>
                                                        <i class="fa fa-calendar"></i><a>{{date("M d,Y",strtotime($item['created_at']))}}</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
